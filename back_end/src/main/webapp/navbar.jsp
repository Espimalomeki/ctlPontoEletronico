          ...
          <c:if test = "${sessionScope.perfil != 'RH'}">
            <li class="nav-item">
              <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown1" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Funcionários</a>
                  ...
                  <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                    <a class="dropdown-item" href="cadastrarFuncionarios.html">Cadastrar Funcionário</a>
                    <a class="dropdown-item"  href="listaFuncionariosDepartamento.html">Lista de Funcionários por Departamento</a>
                  </div>
            </li>
          </c:if>
