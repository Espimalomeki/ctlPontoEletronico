                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form class="validation" name="filtraFuncionario" action="<%=request.getContextPath()%>/PDFiltro" target="_blank" method="post" novalidate>
                                <h1>Fichas de Funcionarios</h1>
                                <p>

                                    <input class="input-group input-group-sm mb-3" type="text" value="" name="matricula">
                                    <button class="btn btn-primary btn-lg" type="submit" name="enviar" value="Enviar" novalidate>Filtrar dados por matricula</button>           
                            </form>
                ...
                <div class="col-sm-6">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <p class="card-text">Visualize as fichas de funcionario</p>
                        </div>
                    </div>
                </div>
