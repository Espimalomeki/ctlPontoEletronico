                ...
                <form class="validation" name="editaFunc" action="<%=request.getContextPath()%>/EditarFuncionario" method="post" novalidate>
                    <div class="mb-3">
                        ...
                        <div class="input-group">
                            <input type="text" class="form-control" name="numMatricula" value="<%=request.getParameter("id")%>" readonly>
                        </div>
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <div class="input-group">
                            <input type="text" class="form-control" name="nome" value="<%=request.getParameter("nome")%>" required>
                    ...
                    <div class="mb-3">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" class="form-control" name="cpf" value="<%=request.getParameter("cpf")%>" maxlength="11" readonly>
                            <div class="invalid-feedback" style="width: 100%;">
                                CPF é requerido.
                            </div>
                        </div>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" name="rne" value="<%=request.getParameter("rne")%>">
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="date" class="form-control" name="dataNascimento" value="<%=request.getParameter("datanasc")%>">
                    </div>

                    <div class="mb-3">
                        <label>Telefone:</label><br>
                        <input type="text" class="form-control" name="telefone" value="<%=request.getParameter("telefone")%>" onkeypress="$(this).mask('(00) 00000-0009')">
                        <div class="invalid-feedback">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" name="contaBancaria" value="<%=request.getParameter("contabanc")%>">
                        <div class="invalid-feedback">
                    ...
                    <div class="mb-3">
                        ...
                        <div class="input-group">
                            <input type="text" name="endereco" class="form-control" value="<%=request.getParameter("endereco")%>" required><br>
                            <div class="invalid-feedback" style="width: 100%;">
                    ...
                    <div class="mb-3">
                        ...
                        <div class="input-group">
                            <input type="text" class="form-control" name="complemento" value="<%=request.getParameter("complemento")%>">
                        </div>
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <input type=date class="form-control" name="dataAdmissao" value="<%=request.getParameter("dtadmissao")%>" >
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" class="form-control salario" name="salario" value="<%=request.getParameter("salario")%>">
                        </div>
                    </div>
