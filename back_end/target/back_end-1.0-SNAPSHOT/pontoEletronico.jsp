    ...
    <div class="col-sm-4">
      <div class="card">
        <div class="card-body">
          ...
          <p class="card-text">Entrada: 10:05</p>
          <p class="card-text">Saída para Almoço: 13:01</p>
          <p class="card-text">Volta do Almoço: 14:01</p>
          <p class="card-text">Saída: 10:05</p>
        </div>
      </div>
    </div>
    <div class="col-sm-4">
